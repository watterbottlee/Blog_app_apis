...
import com.kanishk.blog.services.CategoryService;
...
public class CategoryController {
	...
	//update
	@PutMapping("/{catId}")
	public ResponseEntity<CategoryDto> createCategory(@Valid @RequestBody CategoryDto categorydto, @PathVariable("catId") Integer uid){
	...
	@GetMapping("/{catId}")
	public ResponseEntity<CategoryDto> getCategory(@RequestBody @PathVariable Integer catId){
